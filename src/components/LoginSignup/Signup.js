    ...
    return (
        <div className="auth-from-container">
            <from className="signup-form" onSubmit={handleSubmit}>
                ...
                <input value={name} onChange={(e) => setName(e.target.value)} type="name"  placeholder="full name"/></label>
                ...
                <input value={confirm} onChange={(e) => setConfim(e.target.value)} type="password" placeholder="Retype password"/></label>
                <Link to="/adventure"> 
